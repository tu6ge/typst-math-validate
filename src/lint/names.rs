...
/// Built-in math functions from the Typst math module docs:
...
pub const MATH_FUNCTIONS: &[&str] = &[
    ...
    "ceil",
    "floor",
    // Accents usable as calls (grave(a), hat(x), …)
    "grave",
    "acute",
    "hat",
    "tilde",
    ...
    "caron",
    "harpoon",
    // Predefined text operators (math.op docs)
    "arccos",
    "arcsin",
    "arctan",
    "arg",
...
pub const LATEX_IDENT_ALIASES: &[&str] = &[
    "matrix", "pmatrix", "bmatrix", "vmatrix", "Vmatrix", "iint", "iiint", "oint",
];
